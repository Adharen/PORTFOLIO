...
function Skill() {
    ...
    return (
        <div style={{ minHeight: "100vh", opacity: "1.1", color: "#fff", filter: "opacity(0.8)", background: "#000" }} id="Skill">
            <h1 style={{ textAlign: "center", paddingTop: "70px" }}>Skills</h1>
            <div className="skill" >
            ...
            {/* <Box sx={{ maxWidth: 400 }} style={{margin:"0 auto"}}>
                ...
                {activeStep === steps.length && (
                    <Paper square elevation={0} sx={{ p: 3 }}>
                        <Typography>Thank You For Reading</Typography>
